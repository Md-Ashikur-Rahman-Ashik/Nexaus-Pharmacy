    ...
    try {
      ...
      if (await file.exists()) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('কোনো ডাটাবেস পাওয়া যায়নি!')),
        );
      }
    } catch (e) {
      if (!context.mounted) return;
  ...
  Future<void> _restoreDatabase(BuildContext context) async {
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'ডাটাবেস রিস্টোর করলে বর্তমান সব ডেটা মুছে যাবে এবং ব্যাকআপ ফাইলের ডেটা বসবে। আপনি কি নিশ্চিত?',
        ),
        actions: [
          TextButton(
          ...
          FilledButton(
            ...
            child: const Text('হ্যাঁ, রিস্টোর করুন'),
          ),
        ],
      ),
    );
    ...
    try {
      ...
      if (result != null && result.files.single.path != null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              'সফলভাবে ডাটাবেস রিস্টোর হয়েছে! অ্যাপ রিফ্রেশ করুন।',
            ),
            ...
            if (data.expiringSoon.isNotEmpty) ...[
              ...
              Card(
                ...
                child: const ListTile(
                  ...
                  title: Text(
                    'কোনো ওষুধ আগামী ৩০ দিনে মেয়াদোত্তীর্ণ হবে না।',
